...
<html>
    ...
    <div class="container">
        <div class="topnav" id="myTopnav">
            ...
            <a href="/projeto/php/admin/index.php">Usuarios</a>
            <a href="\admin/loja/index.php">Lojas</a> 
...
<legend style="text-align: center; margin-top: -80px;">Formulario de Cadastro</legend><br>
 <div class="container">
    <div class="row">
        <form class="form-inline" action="cadastrar_usuario.php" method="POST">
            ...
            <div class="form-group mx-sm-3">
                        <input name="data_nascimento" type="date" class="form-control" id="exampleInputPassword1" placeholder="Data Nascimento">
                </div>
                    <div class="form-group mx-sm-3">
                         <input name="telefone" type="number" class="form-control" id="exampleInputPassword1" placeholder="Telefone">
                    </div>
                    <br><br><br><input name="cadastrar" type="submit" class="btn btn-primary" value="Cadastrar">
                ...
                <table class="table" id="table-rs">
                    ...
                    <?php foreach ($dao->findAll() as $key => $value): ?>
                        <tr>
                            ...
                            <td>
                                <a href="form_editar_usuario.php?id=<?php echo $value['id'] ?>" class="btn btn-primary" onlick="alterar(nome,email,senha,data_nascimento,telefone);">Editar</a>
